...
def plot_pxt_gantt(df_results,params,demand, shift_time:int, show=True, version=0):
    ...
    fig.write_html(f'v10_m{machines}_j{jobs}_u{maxlots}_s{seed}_d{demand}_sht{shift_time}_setup_no_pmtn_v{version}_multiEC_postproc2.html', (machines,jobs,maxlots, seed,demand, version), auto_open=True if show else False)
