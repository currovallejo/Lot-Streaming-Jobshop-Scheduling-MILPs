...
#--------- PLOT GANTT CHART ---------
def plot_pxt_gantt(df_results,params,demand, show=True, version=0):
    ...
    fig.write_html(f'v5_m{machines}_j{jobs}_u{maxlots}_s{seed}_d{demand}_setup_no_pmtn_v{version}.html', (machines,jobs,maxlots, seed,demand, version), auto_open=True if show else False)
