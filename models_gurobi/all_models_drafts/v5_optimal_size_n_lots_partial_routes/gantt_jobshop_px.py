...
def print_pxt_gantt(df_results,machines,jobs,maxlots,seed,demand):
    ...
    # fig.show()
    fig.write_html(f'v5_m{machines}_j{jobs}_u{maxlots}_s{seed}_d{demand}_setup_no_pmtn.html', (machines,jobs,maxlots, seed,demand), auto_open=True)
